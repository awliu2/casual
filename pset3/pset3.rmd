...
```
The null hypothesis is that the coefficients of \texttt{treat} are zero in all the equations of the system. The alternative hypothesis is that there is at least one equation with a nonzero coefficient, implying that the control and treatment froups have different means for an OPV. 
...
A potential mechanism for the estimated ATE of being offered training could be skill enhancement, enabling workers to secure better-paying positions that have more skill requirements. Additionally, training may facilitate the expansion of professional networks, offering opportunities for workers to forge connections that lead to more lucrative and desirable job opportunities.
