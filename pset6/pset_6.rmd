...
have closest distance in terms of propensity score. In radius matching, we choose control units that are within certain neighborhood of propensity scores. 
For radius matching we choose controls that are within a certain neibhorhood of propensity scores. For kernel matching we choose a kernel function as the distance metric and weight propensity by similarity.
