...
\end{Shaded}
  ...
  \item
    ...
    \textbf{Answer:} The partialling-out interpretation tells us that
    SLRMs and MLRMs estimators are equivalent: from the background, we
    have the following forms for SLRMs and MLRMs: \newline
    \[\text{SLRM: }y_i=\alpha+\beta x_i + u_i, \text{ where $x_i$ is a single regression covariate.}\]
    \newline
