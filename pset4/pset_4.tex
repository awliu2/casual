...
\end{verbatim}
  ...
  \item
    ...
    (\ref{TCcomp}) and (\ref{CFnc})? It seems to be somewhere in between
    the other two estimators - its value of \(-603.6\) lies somewhere in
    between the TCC estimate of \(-15204.78\) and the Adj. TCC estimate
    of \(217.9\). It is difficult to comment on the validity of the DML
