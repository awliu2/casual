...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df18}\SpecialCharTok{$}\NormalTok{diff\_fte }\OtherTok{=}\NormalTok{ df18}\SpecialCharTok{$}\NormalTok{fte2 }\SpecialCharTok{{-}}\NormalTok{ df18}\SpecialCharTok{$}\NormalTok{fte}
\FunctionTok{print}\NormalTok{(}\FunctionTok{mean}\NormalTok{(df18}\SpecialCharTok{$}\NormalTok{diff\_fte))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{sd}\NormalTok{(df18}\SpecialCharTok{$}\NormalTok{diff\_fte))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df18}\SpecialCharTok{$}\NormalTok{NJdummy }\OtherTok{=}\NormalTok{ df18}\SpecialCharTok{$}\NormalTok{southj }\SpecialCharTok{+}\NormalTok{ df18}\SpecialCharTok{$}\NormalTok{northj }\SpecialCharTok{+}\NormalTok{ df18}\SpecialCharTok{$}\NormalTok{centralj }\SpecialCharTok{+}\NormalTok{ df18}\SpecialCharTok{$}\NormalTok{shore}
\NormalTok{df18 }\OtherTok{=}\NormalTok{ df18 }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{NJdummy =} \FunctionTok{if\_else}\NormalTok{(NJdummy }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
