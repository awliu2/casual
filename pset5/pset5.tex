...
\NormalTok{x }\OtherTok{\textless{}{-}}\NormalTok{ stats}\SpecialCharTok{::}\FunctionTok{model.matrix}\NormalTok{(pscore\_formula, }\AttributeTok{data =}\NormalTok{ dt\_psid)[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{] }
\CommentTok{\# Outcome variable}
\NormalTok{y }\OtherTok{\textless{}{-}}\NormalTok{ dt\_psid}\SpecialCharTok{$}\NormalTok{treat }
