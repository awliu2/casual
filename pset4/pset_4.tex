...
\end{Shaded}
    ...
    \bottomrule\noalign{}
    \endlastfoot
    Estimate & -15204.78 & 1154.614 & -13.169 & 2.033e-38 \\
    \end{longtable}
  \item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hetero\_robust\_se }\OtherTok{\textless{}{-}}\NormalTok{ car}\SpecialCharTok{::}\FunctionTok{hccm}\NormalTok{(m1, }\AttributeTok{type =} \StringTok{"hc0"}\NormalTok{)}
\NormalTok{lmtest}\SpecialCharTok{::}\FunctionTok{coeftest}\NormalTok{(m1, }\AttributeTok{vcov. =}\NormalTok{ hetero\_robust\_se)}
\end{Highlighting}
\end{Shaded}
...
## (Intercept)  21553.92     311.67  69.157 < 2.2e-16 ***
## treat       -15204.78     655.67 -23.190 < 2.2e-16 ***
## ---
...
\tightlist
\item
  See table below for the heteroschedasticity-robust SEs.
\end{enumerate}
...
The result in Q4a is -15204.78 which is equal to the difference between
the average post-training earnings of the treated and of the control
individuals, which is also equal to -15204.78.
...
\tightlist
\item
  The TCC approach uses the control group as a proxy for the missing
  potential outcome of the treatment group if they had not been treated,
  and vice versa. However, if the control group is not comparable with
  the treated group, the proxy is invalid. For instance, from the
  summary statistics provided, we can see that there are differences in
  characteristics such as age, education, and race between the treated
  and control groups. These differences suggest that the groups may not
  be comparable and thus the TCC approach may not deliver a credible
  estimate of the average effect of the treatment of interest.
\end{enumerate}
...
\NormalTok{    coeff }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(m2)}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"treat"}\NormalTok{, }\FunctionTok{c}\NormalTok{(}\StringTok{"Estimate"}\NormalTok{, }\StringTok{"Std. Error"}\NormalTok{)]}
...
\NormalTok{    result\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Estimate =}\NormalTok{ coeff[}\StringTok{"Estimate"}\NormalTok{],}
                            \AttributeTok{Std\_Error =}\NormalTok{ coeff[}\StringTok{"Std. Error"}\NormalTok{],}
                            \AttributeTok{t\_value =}\NormalTok{ test\_stats[}\DecValTok{2}\NormalTok{, }\StringTok{"t value"}\NormalTok{],}
                            \AttributeTok{Pr =} \FunctionTok{formatC}\NormalTok{(test\_stats[}\DecValTok{2}\NormalTok{, }\StringTok{"Pr(\textgreater{}|t|)"}\NormalTok{],}
                                        \AttributeTok{format =} \StringTok{"e"}\NormalTok{,}
                                        \AttributeTok{digits =} \DecValTok{3}\NormalTok{))}
...
\NormalTok{m3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(re78 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ resid\_m2, }\AttributeTok{data =}\NormalTok{ nswpsid)}
\CommentTok{\# get coefficients}
\NormalTok{coeff }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(m3)}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"resid\_m2"}\NormalTok{, }\FunctionTok{c}\NormalTok{(}\StringTok{"Estimate"}\NormalTok{, }\StringTok{"Std. Error"}\NormalTok{)]}
\NormalTok{test\_stats }\OtherTok{\textless{}{-}}\NormalTok{ lmtest}\SpecialCharTok{::}\FunctionTok{coeftest}\NormalTok{(m3, }\AttributeTok{vcov. =} \FunctionTok{vcov}\NormalTok{(m3))}
\NormalTok{result\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Estimate =}\NormalTok{ coeff[}\StringTok{"Estimate"}\NormalTok{],}
                        \AttributeTok{Std\_Error =}\NormalTok{ coeff[}\StringTok{"Std. Error"}\NormalTok{],}
                        \AttributeTok{t\_value =}\NormalTok{ test\_stats[}\DecValTok{2}\NormalTok{, }\StringTok{"t value"}\NormalTok{],}
                        \AttributeTok{Pr =} \FunctionTok{formatC}\NormalTok{(test\_stats[}\DecValTok{2}\NormalTok{, }\StringTok{"Pr(\textgreater{}|t|)"}\NormalTok{],}
...
\NormalTok{m3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(re78 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ constant }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ agesq }\SpecialCharTok{+}
\NormalTok{                 edu }\SpecialCharTok{+}\NormalTok{ nodegree }\SpecialCharTok{+}\NormalTok{ black }\SpecialCharTok{+} 
\NormalTok{                 hisp }\SpecialCharTok{+}\NormalTok{ re74 }\SpecialCharTok{+}\NormalTok{ re75, }
         \AttributeTok{data =}\NormalTok{ nswpsid\_const)}
\CommentTok{\# get residuals}
\NormalTok{resid\_m3 }\OtherTok{\textless{}{-}}\NormalTok{ m3}\SpecialCharTok{$}\NormalTok{residuals}
\end{Highlighting}
\end{Shaded}
    \item
...
\NormalTok{m4 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(resid\_m3 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ resid\_m2)}
\CommentTok{\# get coefficients}
\NormalTok{coeff }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(m4)}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"resid\_m2"}\NormalTok{, }\FunctionTok{c}\NormalTok{(}\StringTok{"Estimate"}\NormalTok{, }\StringTok{"Std. Error"}\NormalTok{)]}
\NormalTok{test\_stats }\OtherTok{\textless{}{-}}\NormalTok{ lmtest}\SpecialCharTok{::}\FunctionTok{coeftest}\NormalTok{(m4, }\AttributeTok{vcov. =} \FunctionTok{vcov}\NormalTok{(m4))}
\NormalTok{result\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Estimate =}\NormalTok{ coeff[}\StringTok{"Estimate"}\NormalTok{],}
                        \AttributeTok{Std\_Error =}\NormalTok{ coeff[}\StringTok{"Std. Error"}\NormalTok{],}
                        \AttributeTok{t\_value =}\NormalTok{ test\_stats[}\DecValTok{2}\NormalTok{, }\StringTok{"t value"}\NormalTok{],}
                        \AttributeTok{Pr =} \FunctionTok{formatC}\NormalTok{(test\_stats[}\DecValTok{2}\NormalTok{, }\StringTok{"Pr(\textgreater{}|t|)"}\NormalTok{],}
